...
function $s_Lorg_isolema_utils_MapOrtographicAccent$__mapWord__Lorg_isolema_utils_MapOrtographicAccent$__T__T($this, word) {
  var this$2 = new $c_sci_StringOps().init___T(word);
  ...
  while ((i < len)) {
    ...
    if ((arg1 === null)) {
      ...
      var ch = this$6.value$1
    };
    var x1 = $as_sci_Map($this.mapChar).get__O__s_Option(new $c_jl_Character().init___C(ch));
    if ($is_s_Some(x1)) {
      var x2 = $as_s_Some(x1);
      var c = x2.value$2;
      if ((c === null)) {
  ...
  return $as_T(b.result__O())
}
/** @constructor */
function $c_Lorg_isolema_utils_MapOrtographicAccent$() {
  $g.Object.call(this);
  this.mapChar = $as_sci_Map($m_s_Predef$().Map__sci_Map$().apply__sc_Seq__sc_GenMap(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_s_Predef$ArrowAssoc$().$$minus$greater$extension__O__O__T2($m_s_Predef$().ArrowAssoc__O__O($m_sr_BoxesRunTime$().boxToCharacter__C__jl_Character(225)), $m_sr_BoxesRunTime$().boxToCharacter__C__jl_Character(97)), $m_s_Predef$ArrowAssoc$().$$minus$greater$extension__O__O__T2($m_s_Predef$().ArrowAssoc__O__O($m_sr_BoxesRunTime$().boxToCharacter__C__jl_Character(233)), $m_sr_BoxesRunTime$().boxToCharacter__C__jl_Character(101)), $m_s_Predef$ArrowAssoc$().$$minus$greater$extension__O__O__T2($m_s_Predef$().ArrowAssoc__O__O($m_sr_BoxesRunTime$().boxToCharacter__C__jl_Character(237)), $m_sr_BoxesRunTime$().boxToCharacter__C__jl_Character(105)), $m_s_Predef$ArrowAssoc$().$$minus$greater$extension__O__O__T2($m_s_Predef$().ArrowAssoc__O__O($m_sr_BoxesRunTime$().boxToCharacter__C__jl_Character(243)), $m_sr_BoxesRunTime$().boxToCharacter__C__jl_Character(111)), $m_s_Predef$ArrowAssoc$().$$minus$greater$extension__O__O__T2($m_s_Predef$().ArrowAssoc__O__O($m_sr_BoxesRunTime$().boxToCharacter__C__jl_Character(250)), $m_sr_BoxesRunTime$().boxToCharacter__C__jl_Character(117))])))
}
/** @constructor */
function $h_Lorg_isolema_utils_MapOrtographicAccent$() {
  /*<skip>*/
}
$h_Lorg_isolema_utils_MapOrtographicAccent$.prototype = $g.Object.prototype;
$c_Lorg_isolema_utils_MapOrtographicAccent$.prototype = new $h_Lorg_isolema_utils_MapOrtographicAccent$();
$c_Lorg_isolema_utils_MapOrtographicAccent$.prototype.constructor = $c_Lorg_isolema_utils_MapOrtographicAccent$;
$c_Lorg_isolema_utils_MapOrtographicAccent$.prototype.mapWord = (function(arg$1) {
  var prep0 = $as_T(arg$1);
  return $s_Lorg_isolema_utils_MapOrtographicAccent$__mapWord__Lorg_isolema_utils_MapOrtographicAccent$__T__T(this, prep0)
});
var $n_Lorg_isolema_utils_MapOrtographicAccent$ = (void 0);
function $m_Lorg_isolema_utils_MapOrtographicAccent$() {
  if ((!$n_Lorg_isolema_utils_MapOrtographicAccent$)) {
    $n_Lorg_isolema_utils_MapOrtographicAccent$ = new $c_Lorg_isolema_utils_MapOrtographicAccent$()
  };
  return $n_Lorg_isolema_utils_MapOrtographicAccent$
}
$e.scalaUtil = $m_Lorg_isolema_utils_MapOrtographicAccent$;
function $s_Lorg_isolema_utils_Utils$__decomposeWordByOccur__Lorg_isolema_utils_Utils$__T__T($this, word) {
  var this$3 = new $c_sci_StringOps().init___T(word);
  var this$2 = $m_s_Predef$();
  var bf = new $c_s_LowPriorityImplicits$$anon$4().init___s_LowPriorityImplicits(this$2);
  var codeZip = $as_sci_IndexedSeq($f_sc_IndexedSeqOptimized__zipWithIndex__scg_CanBuildFrom__O(this$3, bf));
  var f = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(this$2$1, word$1) {
    return (function(cz$2) {
      var cz = $as_T2(cz$2);
      var this$5 = new $c_sci_StringOps().init___T(word$1);
      var n = ((1 + $uI(cz.$$und2$f)) | 0);
      var $$this = this$5.repr$1;
      var until = $uI($$this.length);
      var x = $m_sci_StringOps$().slice$extension__T__I__I__T(this$5.repr$1, n, until);
      var this$13 = new $c_sci_StringOps().init___T(x);
      var c = cz.$$und1$f;
      if ((c === null)) {
        var c$1 = 0
      } else {
      ...
      if ($f_sc_SeqLike__contains__O__Z(this$13, elem)) {
        var jsx$1 = true
      } else {
        var this$15 = new $c_sci_StringOps().init___T(word$1);
        var n$1 = $uI(cz.$$und2$f);
        var x$1 = $m_sci_StringOps$().slice$extension__T__I__I__T(this$15.repr$1, 0, n$1);
        var this$21 = new $c_sci_StringOps().init___T(x$1);
        var c$2 = cz.$$und1$f;
        if ((c$2 === null)) {
          var c$3 = 0
        } else {
          var this$18 = $as_jl_Character(c$2);
          var c$3 = this$18.value$1
        };
        var elem$1 = new $c_jl_Character().init___C(c$3);
        var jsx$1 = $f_sc_SeqLike__contains__O__Z(this$21, elem$1)
      };
      if (jsx$1) {
        var index = $uI(cz.$$und2$f);
        var c$4 = (65535 & $uI(word$1.charCodeAt(index)))
      } else {
        var c$4 = 95
      };
      return new $c_jl_Character().init___C(c$4)
    })
  })($this, word));
  $m_sci_IndexedSeq$();
  var bf$1 = $m_sc_IndexedSeq$().ReusableCBF$6;
  var result = $as_sci_IndexedSeq($f_sc_TraversableLike__map__F1__scg_CanBuildFrom__O(codeZip, f, bf$1));
  return result.mkString__T()
}
/** @constructor */
function $c_Lorg_isolema_utils_Utils$() {
  $g.Object.call(this)
}
/** @constructor */
function $h_Lorg_isolema_utils_Utils$() {
  /*<skip>*/
}
$h_Lorg_isolema_utils_Utils$.prototype = $g.Object.prototype;
$c_Lorg_isolema_utils_Utils$.prototype = new $h_Lorg_isolema_utils_Utils$();
$c_Lorg_isolema_utils_Utils$.prototype.constructor = $c_Lorg_isolema_utils_Utils$;
$c_Lorg_isolema_utils_Utils$.prototype.decomposeWordByOccur = (function(arg$1) {
  var prep0 = $as_T(arg$1);
  return $s_Lorg_isolema_utils_Utils$__decomposeWordByOccur__Lorg_isolema_utils_Utils$__T__T(this, prep0)
});
var $n_Lorg_isolema_utils_Utils$ = (void 0);
function $m_Lorg_isolema_utils_Utils$() {
  if ((!$n_Lorg_isolema_utils_Utils$)) {
    $n_Lorg_isolema_utils_Utils$ = new $c_Lorg_isolema_utils_Utils$()
  };
  return $n_Lorg_isolema_utils_Utils$
}
$e.Utils = $m_Lorg_isolema_utils_Utils$;
...
$c_s_Predef$.prototype.Map__sci_Map$ = (function() {
  return this.Map$2
});
...
$c_scm_ArrayBuffer.prototype.$classData = $d_scm_ArrayBuffer;
//# sourceMappingURL=isolemautils-fastopt.js.map
